#!/usr/bin/env bash
EXPERIMENT_DIR=/data/models/vindel/hp_lightgbm_per_site_last_fold_only
CONFIG_DIR=configs
DATASET_CONFIG=$CONFIG_DIR/dataset_configs/dataset_config.py
TRAINING_CONFIG=$CONFIG_DIR/training_configs/single_epoch_hp_train_config_last_fold_only.py
