...
variables_config = VariableConfig(
    ...
    variable_definitions={
        ...
        "NCEP_GFS": {'WindUMS_Height': Variable('WindUMS_Height'),
                     ...
                     'phi_WindUMS_Height_WindVMS_Height': Variable('phi'),
                     'r_WindUMS_Height_WindVMS_Height': Variable('r'),
                     'site_production': Variable('site_production'),
                     'lead_time': Variable('lead_time'),
                     'time_of_day': Variable('time_of_day')
                     },
        ...
        "ECMWF_EPS-CF": {
            ...
            "t2m": Variable('t2m'),
            'phi_u10_v10': Variable('phi_10'),
            'r_u10_v10': Variable('r_10'),
            'phi_u100_v100': Variable('phi_100'),
            'r_u100_v100': Variable('r_10'),
            'lead_time': Variable('lead_time'),
            'time_of_day': Variable('time_of_day'),
            'site_production': Variable('site_production'),
        },
    ...
    weather_variables={
        ...
        "ECMWF_HRES": ["u10",
                       ...
                       'lead_time',
                       'time_of_day'],
        'DWD_ECMWF_NCEP': ['T', 'U', 'V', 'dwd_phi', 'dwd_r', 'WindUMS_Height', 'WindVMS_Height', 'Temperature_Height', 'ncep_phi', 'ncep_r', "u10",
                           "v10",
                           "u100",
                           "v100",
                           #"u200",
                           ...
                           "i10fg",
                           "t2m",
                           'ec_phi_10', 'ec_r_10', 'ec_phi_100', 'ec_r_100',
                           'lead_time', 'time_of_day'],
        'DWD_ICON-EU#ECMWF_EPS-CF#ECMWF_HRES#NCEP_GFS' :  [
            'DWD_ICON-EU$T',
            'DWD_ICON-EU$U',
            'DWD_ICON-EU$V',
