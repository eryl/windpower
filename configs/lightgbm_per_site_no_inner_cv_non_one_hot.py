...
variables_config = VariableConfig(
    ...
    variable_definitions={
        ...
        'DWD_ECMWF_NCEP' : {
            ...
            "i10fg": Variable('i10fg'),
            "t2m": Variable('t2m'),
            'ec_phi_10': DiscretizedVariableEvenBins('phi_10', (-np.pi, np.pi), 64,
                                                  one_hot_encode=True),
            'ec_r_10': Variable('r_10'),
            'ec_phi_100': DiscretizedVariableEvenBins('phi_10', (-np.pi, np.pi), 64,
                                                   one_hot_encode=True),
            'ec_r_100': Variable('r_10'),
            'site_production': Variable('site_production'),
            'lead_time': Variable('lead_time'),
            'time_of_day': CategoricalVariable('time_of_day', levels=np.arange(24),
                                               one_hot_encode=False),
